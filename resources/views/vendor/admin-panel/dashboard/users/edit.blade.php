            ...
            <div class="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div
                        ...
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-4 text-center">Profile
                            Image</label>
                ...
                <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="relative">
                                    <select name="role" id="role"
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{ $role->slug }}" @if(old('role', $user->roles->first()?->slug) == $role->slug) selected @endif>{{ $role->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" id="status"
                                        class="block w-full pl-11 pr-10 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800 dark:text-gray-100 appearance-none cursor-pointer transition-all duration-200">
                                        <option value="Active" @if(old('status', $user->status) == 'Active') selected @endif>
                                            Active</option>
                                        <option value="Inactive" @if(old('status', $user->status) == 'Inactive') selected
                    ...
                    <!-- Password Section -->
                    <div
                        class="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 rounded-2xl p-6 border-2 border-amber-200 dark:border-amber-800">
                        ...
                        <p class="text-sm text-amber-700 dark:text-amber-300 mb-5">Leave blank to keep the current password
                        </p>
