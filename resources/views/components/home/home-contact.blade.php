        ...
        <div class="bg-[#5C33CF] rounded-[40px] p-8 md:p-12 shadow-2xl relative z-10 w-full max-w-2xl mx-auto lg:ml-0" 
            ...
            <form action="{{ route('contact.submit') }}" method="POST" class="ajax-contact-form space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select
                        name="subject"
                        class="w-full px-6 py-4 rounded-full bg-white text-gray-700 focus:outline-none shadow-inner appearance-none">
...
@php
    ...
    // উত্তরটাকে এনক্রিপ্ট করে নিচ্ছি
    ...
    <input type="number" name="math_captcha" placeholder="?" required
        class="w-24 px-4 py-3 rounded-full border border-[#572BC6] shadow-[0_4px_24px_0_rgba(254,54,104,0.19)] focus:outline-none focus:ring-2 focus:ring-purple-400" />
                ...
                <div class="flex justify-center md:justify-start">
                    <button type="submit"
                        class="submit-btn relative text-white flex items-center gap-2 bg-gradient-to-b from-[#FE3668] to-[#CF0037] pl-10 pr-6 py-3 rounded-full shadow-lg font-bold hover:scale-105 transition transform">
